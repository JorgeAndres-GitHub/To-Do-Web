...
{
    public class GetProfileViewModelUseCase<TEntity, TAuthenticationOutput, TOutput>
    {
        ...
        public GetProfileViewModelUseCase(IAccountRepository<TEntity, TAuthenticationOutput> repository, IAccountPresenter<TEntity, TOutput> presenter)
        {
